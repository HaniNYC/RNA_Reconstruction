...
int main(){
   ...
   if (counter ==1 && lastFragment2.size() >0 && lastFragment1.size()==0 ) { lastFragment= lastFragment2;}
   if ( counter > 1 && lastFragment1[lastFragment1.length()-1]== lastFragment2[lastFragment2.length()-1] =='A'){ // if ends with A
   ...
   { cout <<" ERROR ENTERING FRAGMENTS!, PLEASE TRY AGAIN  "<<endl;
                     ...
                     clock_t end_time =  4000 + start_time;
...
if(vDifferences[0].length() < vDifferences[1].length()){ firstFragment= vDifferences[0];
                                         ...
                                         cout <<"1"<<endl;}
else if(vDifferences[0].length()> vDifferences[1].length()) { firstFragment= vDifferences[1]; //<---------------
